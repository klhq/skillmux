...
`--dry-run` first to inspect the marker paths. Rehome never creates, removes,
or retargets skill links, and it refuses legacy markers or any marker that
cannot be proven to belong to the configured vault.
